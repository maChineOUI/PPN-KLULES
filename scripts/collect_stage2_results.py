...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Collect stage2 cluster result metrics into one CSV."
    )
    parser.add_argument(
        "--reports-dir",
        default="cluster/stage2/reports",
        help="Root directory containing stage2-cluster-* result folders.",
    )
    parser.add_argument(
        "--pattern",
        default="stage2-cluster-*",
        help="Glob for result directories under --reports-dir.",
    )
    parser.add_argument(
        "--output",
        default="cluster/stage2/reports/stage2_results_summary.csv",
        help="Output CSV path.",
    )
    parser.add_argument(
        "--compact-output",
        default="cluster/stage2/reports/stage2_results_compact.csv",
